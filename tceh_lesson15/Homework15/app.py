...
import tceh_lesson15.Homework15.config as config
...
def comments_only():
    ...
    return render_template('comments_only.html', post_notes=post_notes)


@app.route('/comment', methods=['GET', 'POST'])
def comments_index():
    from tceh_lesson15.Homework15.models import Post
    from tceh_lesson15.Homework15.forms import PostForm
...
def all_notes():
    ...
    for note in post_notes:
        # print(post_text)
        print(note.post_text)
    return render_template('articles_and_comments.html', article_notes=article_notes, post_notes=post_notes)
...
if __name__ == '__main__':
    from tceh_lesson15.Homework15.models import *
    db.create_all()
